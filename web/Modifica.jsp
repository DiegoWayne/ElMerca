            ...
            <form action="Modifica" method="post" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group has-feedback">
                  ...
                  <input  name="IDA" type="hidden" value='<% out.println(request.getParameter("ID")); %>' >
                  <input type="text" class="form-control" placeholder="Nombre del producto" name="Nombre" 
                  <% out.println("value='"+Temp.getString("Articulo_Nombre")+"'"); %> required="">
                ...
                <!--Lista de las imagenes-->
                 <ul class="mailbox-attachments clearfix">
                     ...
                     <li>
                     <span class="mailbox-attachment-icon has-img"><img id="Img_1" <% out.println("src='data:image/jpeg;base64,"+Conex.Imagen(Temp.getBlob("Articulo_Imagen_1"))+"'"); %>  ></span>
                    ...
                    <li>
                     <span class="mailbox-attachment-icon has-img"><img id="Img_2" <% out.println("src='data:image/jpeg;base64,"+Conex.Imagen(Temp.getBlob("Articulo_Imagen_2"))+"'"); %>  ></span>
                      <div class="mailbox-attachment-info">
                    ...
                    <li>
                     <span class="mailbox-attachment-icon has-img"><img id="Img_3" <% out.println("src='data:image/jpeg;base64,"+Conex.Imagen(Temp.getBlob("Articulo_Imagen_3"))+"'"); %>   ></span>
                      <div class="mailbox-attachment-info">
                    ...
                    <!--Formato del video-->
                    <li>
                     <span class="mailbox-attachment-icon has-img"><video width="100%" height="100%" controls id="VideoPre"><source <% out.println("src='"+Temp.getString("Articulo_Precio")+"'"); %> type="video/mp4"></video></span>
                      <div class="mailbox-attachment-info">
                ...
                <textarea class="form-control" rows="3" placeholder="Descripcion del producto..." name="Descripcion" required="" ><% out.println(Temp.getString("Articulo_Descripcion")); %></textarea>
                <div class="col-xs-6">
                          <div class="table-responsive">
                            <table class="table">
                              <tbody><tr>
                                <th style="width:50%">Precio:</th>
                                <td><input type="number" name="Precio" <% out.println("value='"+Temp.getString("Articulo_Precio")+"'"); %> required=""></td>
                              </tr>
                              <tr>
                                <th>Unidades</th>
                                <td><input type="number" name="Unidades" <% out.println("value='"+Temp.getString("Articulo_Unidades")+"'");} %> required=""></td>
                              </tr>
                              <tr>
                                <th>Categoria</th>
                                <td>
                ...
                <a href=<% out.println("'scrips/Eliminar.jsp?ID="+request.getParameter("ID")+"'"); %> class="btn btn-primary btn-block btn-danger">Eliminar</a>
              </div>
            </form>
          </div>

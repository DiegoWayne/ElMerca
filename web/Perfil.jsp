               ...
               <!--Ventas-->
                ...
                %>
                  ...
                  <a class="description-text" href="SubirArticulo.jsp">Agregar Producto</a>
                           ...
                           <a href="Historial.jsp"><h5 class="widget-user-desc">Historial de compras</h5></a>
                  </div>
                </div>
     ...
     <!--Fin del contenedor de los datos de usuario-->
      ...
      <div class="box-body">
        <ul class="products-list product-list-in-box">
          ...
          <%
                 if(request.getParameterMap().containsKey("ID"))
                   Temp=Conex.VerProductosUsuario((String)session.getAttribute("ID"));
                 else
                   Temp=Conex.VerProductosUsuario((String)session.getAttribute("ID"));
                            while(Temp.next())
                            {
                                ...
                                if(request.getParameterMap().containsKey("ID")==false)
                                   out.println("<a href='Modifica.jsp?ID="+Temp.getString("Articulo_ID")+"'><span class='label label-info pull-right'>Editar</span></a>");

             ...
             <ul class="dropdown-menu" role="menu">
                <%
                   String Titulo="";
                    ...
                    while(Temp.next())
                    {
                       if(Temp.getString("Categoria_ID").equals(request.getParameter("ID")))
                           Titulo=Temp.getString("Categoria_Nombre");
          ...
          <!-- Lista de con mas visitas -->
            <li>
              ...
              <div class="timeline-item">
                  <h3 class="timeline-header"> <strong><% out.println(Titulo);%></strong> </h3>
                  <div class="timeline-body">
                  <div class="row">
                 <%
                   Temp=Conex.VerCategoria(request.getParameter("ID"));
                      while(Temp.next())
                            {
